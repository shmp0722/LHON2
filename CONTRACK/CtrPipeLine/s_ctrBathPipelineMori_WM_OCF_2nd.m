...
%
    ...
    ctrParams.projectName = 'Mori_OCF_WM';
...
%     ctrParams.roi1 = {'Mori_LOcc','Mori_ROcc'};
    ctrParams.roi1 = {'ctx-lh-pericalcarine','ctx-rh-pericalcarine'};
    ctrParams.roi2 = {'Right-WhiteMatter','Left-WhiteMatter',};
