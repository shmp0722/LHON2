...
baseDir = '/biac4/wandell/biac2/wandel/data/DWI-Tamagawa-Japan';
cd(baseDir)
...
%
    ...
    ctrParams.projectName = 'Top200000_dilated';
    ...
    ctrParams.subs = {'JMD1-MM-20121025-DWI'
    ...
    ctrParams.roi1 = {'Rt-LGN','Lt-LGN'};
    ctrParams.roi2 = {'ctx-rh-pericalcarine.nii_1_cleaned','ctx-lh-pericalcarine.nii_1_cleaned'};
