function SO_Pipeline_OCF_From_fsCC_ToBothV1_1st
...
for i = 1:length(subDir)
    ...
    fgDir = (fullfile(SubDir,'/dwi_1st/fibers/conTrack/OCF_Top50K_FromfsCC_To_Both_V1V2_3mm'));
...
%         cd(fullfile(SubDir,'/dwi_1st/fibers'))
%         switch k 
%             case 1
%                 name = 'LOCF_D4L4.pdb';
%             case 2
...
%     roiDir = fullfile(SubDir,'/dwi_2nd/ROIs');
    ...
    % load fg
    fgf = dir('fg_OCF_Top50K*Matter_AFQ_D4_L4.pdb');
    % k==1, lh; K ==2, rh
