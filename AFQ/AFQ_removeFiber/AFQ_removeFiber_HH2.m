...
fiberfile_pdb = {...
    'fg_Top200000_Rt-LGN_ctx-rh-pericalcarine_2013-03-15_13.48.17.pdb'
...
for ii=1:length(subs)
    ...
    fgDir = fullfile(homeDir,subs{ii},'dwi_1st','fibers','conTrack','Top200000');
    
   
    
    for ij = 1:length(fiberfile_pdb)
        
        fgfile = fullfile(homeDir,subs{ii},'dwi_1st','fibers','conTrack','Top200000',fiberfile_pdb{ij});
