...
%     'LHON5-HS-20121220-DWI'AFQ_removeFiber_HH.m
...
% /biac4/wandell/biac2/wandell/data/DWI-Tamagawa-Japan/JMD-Ctl-SY-20130222DWI/dwi_2nd/fibers/fg_Top200000_Lt-LGN_ctx-lh-pericalcarine_2013-03-04_12.00.16-NOTcoronal-CC_NOT-NOThemi-NOTcoronal-NOTcoronal.pdb
fiberfile_pdb = {...
    'fg_Top200000_Lt-LGN_ctx-lh-pericalcarine_2013-03-04_12.00.16-NOTcoronal-CC_NOT-NOThemi-NOTcoronal-NOTcoronal.pdb'
%     'fg_Top200000_Lt-LGN_ctx-lh-pericalcarine_2013-03-15_13.48.17.pdb'
    };
...
for ii=1:length(subs)
    ...
    fgDir = fullfile(homeDir,subs{ii},'dwi_2nd','fibers');
    ...
    for ij = 1:length(fiberfile_pdb)
        ...
        for i=2:4;
            ...
            fibersubnane    = fiberfile_pdb{ij}([Indexunderscore(1)+1:Indexunderscore(4)-1]);
            fibername       = sprintf('%s/%sMD%d.pdb',fgDir,fibersubnane,maxDist);
%             savefile        = fullfile(fibername);
