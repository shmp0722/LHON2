function afq = AFQ_AddNewFiberGroup_3(afq,fgName,roi1Name,roi2Name,cleanFibers,computeVals,showFibers,segFgName,overwrite)
...
%             if fg_classified.fibers{jj}(1,1) < fg_classified.fibers{jj}(1,end);
