...
for i = 1:length(subDir);
    ...
    switch i
        ...
        case {21}
            fgfile = {'fg_OR_Top100K_V1_3mm_clipped_Lt-LGN_lh_V1_smooth3mm_NOT_2013-07-08_15.32.37.pdb'
                'fg_OR_Top100K_V1_3mm_clipped_Rt-LGN_rh_V1_smooth3mm_NOT_2013-07-08_15.32.37.pdb'};
    end
