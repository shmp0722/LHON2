...
for ii = 1:AFQ_get(afq,'numsubs')
    ...
    if computeVals == 1
        ...
        % calculated
        [fa, md, rd, ad, cl, volume, TractProfile] =...
            AFQ_ComputeTractProperties(fg_classified, dt, 30, afq.params.clip2rois, afq.sub_dirs{ii}, fWeight, afq);
%                     AFQ_ComputeTractProperties(fg_classified, dt, afq.params.numberOfNodes, afq.params.clip2rois, afq.sub_dirs{ii}, fWeight, afq);
