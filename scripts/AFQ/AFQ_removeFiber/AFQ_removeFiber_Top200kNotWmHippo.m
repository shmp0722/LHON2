...
fiberfile_pdb = {...
    'fg_Top200000_Lt-LGN_ctx-lh-pericalcarine_2013-03-04_12.00.16-rightWhite-Left-Hippocampus.nii_1.pdb'
    'fg_Top200000_Rt-LGN_ctx-rh-pericalcarine_2013-03-04_12.00.16-leftWhite-Right-Hippocampus.nii_1.pdb'
    };

%% Run AFQ_removeFiberOutliers loop 


for ii = 3:4 %length(subs)
    
    fgDir = fullfile(homeDir,subs{ii},'dwi_2nd','fibers','conTrack','Top200kNotWmHippo');
