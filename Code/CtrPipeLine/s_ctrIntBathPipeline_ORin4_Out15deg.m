function s_ctrIntBathPipeline_ORin4_Out15deg
...
%
    ...
    ctrParams.projectName = 'Out30degree';
...
% set parameter
    ctrParams.roi1 = {'Rt-LGN4','Lt-LGN4'};
    ctrParams.roi2 = {'rh_Peri30Degree_ecc','lh_Peri30Degree_ecc'};
    ctrParams.nSamples = 30000;
    ctrParams.maxNodes = 240;
    ctrParams.minNodes = 20; % defalt: 10
