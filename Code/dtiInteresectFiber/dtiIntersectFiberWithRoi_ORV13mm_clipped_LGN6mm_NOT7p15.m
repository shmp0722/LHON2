...
for i =5; %21:length(subDir);
        
    SubDir=fullfile(homeDir,subDir{i});
    fgDir = (fullfile(SubDir,'/dwi_2nd/fibers/conTrack/OR_Top100K_V1_3mm_clipped_LGN6mm')); 
    cd(fgDir)
    
fgfile =...
'fg_OR_Top100K_V1_3mm_clipped_LGN4mm_Rt-LGN6_rh_V1_smooth3mm_NOT_2013-07-10_12.23.58.pdb';
%     % load whole brain fg
%     switch i
