...
%     cd(SubDir)
    ...
    % select fg
    fgfile = {...
        'fg_Top100000_Rt-LGN_ctx-rh-pericalcarine_2013-03-11_10.31.22.pdb'...
        'fg_Top100000_Lt-LGN_ctx-lh-pericalcarine_2013-03-11_10.31.22.pdb'...
            };
...
%         end
            ...
            savefile  = fullfile(SubDir,'dwi_1st','fibers','conTrack','T3Top100kNotWmHippo');
            cd(savefile)      
