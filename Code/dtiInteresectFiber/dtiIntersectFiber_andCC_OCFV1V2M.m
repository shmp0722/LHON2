...
for ii = 1:length(subs);
    ...
    ctrDir = (fullfile(SubDir,'/dwi_2nd/fibers/conTrack/OCF_Top50K_fsV1V2')); 
    cd(ctrDir)
    
    % select fg and ROI
    fgfile = 'fg_OCF_Top50K_fsV1V2_lh_V1_lh_V2_rh_V1_rh_V2_2013-06-05_18.38.26.pdb';
...
%         fg1 = fgRead(fgfile);
        ...
        % save the pdb file 
        fgOut1.name = 'OCF_Top50K_fsV1V2CC';
