...
for subinds = 1:length(subDir)
    ...
    ctrDir = (fullfile(SubDir,'dwi_2nd','fibers','conTrack','OR_Top100k_ROIdilated')); 
    cd(ctrDir)
    
    % select fg
    fgfile = {...
        'fg_OR_Top100k_ROIdilated_Rt-LGN_ctx-rh-pericalcarine_clean0111_2013-04-23_11.05.48.pdb'...
        'fg_OR_Top100k_ROIdilated_Lt-LGN_ctx-lh-pericalcarine_clean0111_2013-04-23_11.05.48.pdb'...
                    };
