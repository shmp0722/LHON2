%% AFQ_removeFiberOutliers for Callosal Fiber Major
...
% for 1:16
% fiberfile_pdb = {...
%     'fg_OCF_CC_ctx-lh-pericalcarine_2013-03-29_15.41.27-Right-WhiteMatter.pdb'
%     'fg_OCF_CC_ctx-rh-pericalcarine_2013-03-29_15.41.27-Left-WhiteMatter.pdb'
%     };

% for {17} = HT
fiberfile_pdb = {...
    'fg_OCF_CC_ctx-lh-pericalcarine_2013-04-29_16.44.26-Right-WhiteMatter.pdb'
    'fg_OCF_CC_ctx-rh-pericalcarine_2013-04-29_16.44.26-Left-WhiteMatter.pdb'
    };

%% Run AFQ_removeFiberOutliers loop 


for ii=17%:16 %length(subs)
    
    fgDir = fullfile(homeDir,subs{ii},'/dwi_2nd/fibers/conTrack/OCF');
