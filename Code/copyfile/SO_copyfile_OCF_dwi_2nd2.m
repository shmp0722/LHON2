...
for    ii = 1:length(subs)
    ...
    fromfile1 = fullfile(fromDirs,'wholeBrain07+MoriOcc.pdb');
    fromfile2 = fullfile(fromDirs,'wholeBrain+MoriOcc.pdb');
...
%     
    goDirs1 = fullfile(baseDir,subs{ii},'dwi_2nd','fibers','OCF07Mori.pdb');
    goDirs2 = fullfile(baseDir,subs{ii},'dwi_2nd','fibers','OCF20Mori.pdb');
