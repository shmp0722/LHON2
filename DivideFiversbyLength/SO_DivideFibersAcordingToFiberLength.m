function [TractProfile, fg_SDm4,fg_SDm3,fg_SDm2,fg_SDm1,fg_SD1,fg_SD2,fg_SD3,fg_SD4]...
    = SO_DivideFibersAcordingToFiberLength(fg,dt,distribution,direction,Nodes)
...
if sum(SD_4p) <5 ;fg_SD4 =[];
else
    fg_SD4  = dtiNewFiberGroup('fg_SD4','b',[],[],fg_orig.fibers(logical(SD_4p)));
end;

fgF = {fg, fg_SDm4,fg_SDm3,fg_SDm2,fg_SDm1,fg_SD1,fg_SD2,fg_SD3,fg_SD4};
