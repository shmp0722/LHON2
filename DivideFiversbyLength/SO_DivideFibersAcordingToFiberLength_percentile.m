...
<<<<<<< HEAD:Code/3RP/SO_DivideFibersAcordingToFiberLength_percentile.m
...
=======
    ...
    if showHist==1
>>>>>>> simplify:DivideFiversbyLength/SO_DivideFibersAcordingToFiberLength_percentile.m
    figure;hold on;
    [n, xout]=hist(Lmm,20);
